...
ROOT_URLCONF = 'sentiment_analysis_of_customers_reviews.urls'
...
WSGI_APPLICATION = 'sentiment_analysis_of_customers_reviews.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'sentiment_analysis_of_customers_reviews',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
