"""sentiment_analysis_of_customers_reviews URL Configuration
...
from sentiment_analysis_of_customers_reviews import settings
...
urlpatterns = [
    ...
    url(r'^View_Sentiemnt_Type_Ratio/$', serviceprovider.View_Sentiemnt_Type_Ratio, name="View_Sentiemnt_Type_Ratio"),
